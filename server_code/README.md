...
**博客地址：
[https://blog.csdn.net/2303_76227485/article/details/150528914](https://blog.csdn.net/2303_76227485/article/details/150528914)**

**视频演示：
[https://www.bilibili.com/video/BV1TTeuzuEu4/](https://www.bilibili.com/video/BV1TTeuzuEu4/)**

**毕业设计所有选题地址：
[https://github.com/ynwynw/allProject](https://github.com/ynwynw/allProject)**

## 基于Java+Springboot+vue3的快递物流管理系统(源代码+数据库)235
## 一、系统介绍
本项目前后端分离(可以改为ssm版本)，分为用户、员工、管理员三种角色。
### 1、用户：
- 注册、登录、站点查看、取件、寄件、签收、支付、个人信息、密码修改
### 2、员工：
- 站点管理、运输管理、快递入库、用户管理、打卡、取件管理、签收管理、寄件管理、商品出库管理、快递派送
### 3、管理员：
- 站点管理、运输管理、操作日志、快递派送、快递入库、用户管理、打卡管理、取件管理、签收管理、寄件管理、商品出库管理、菜单管理
## 二、所用技术
后端技术栈：
- Springboot
- mybatisPlus
