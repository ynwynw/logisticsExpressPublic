		...
		<el-dialog modal-class="edit_form_modal" class="edit_form" v-model="formVisible" :title="formTitle" width="50%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" :rules="rules">
				<el-row >
					...
					<el-col :span="24">
						<el-form-item label="收件手机号" prop="shoujihaoma">
							<el-input class="list_inp" v-model="form.shoujihaoma" placeholder="收件手机号"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="物品出库" prop="wupinchuku">
							<el-input class="list_inp" v-model="form.wupinchuku" placeholder="物品出库"
                                type="text"
								:readonly="!isAdd||disabledForm.wupinchuku?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='wupinchuku'){
					form.value.wupinchuku = row[x];
					disabledForm.value.wupinchuku = true;
					continue;
				}
				if(x=='jijianzhanghao'){
